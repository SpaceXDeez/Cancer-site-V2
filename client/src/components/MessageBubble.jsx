...
export function AiAvatar() {
  return (
    <div className="w-8 h-8 bg-brand-teal rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
    ...
    return (
      <div className="flex justify-end">
        <div className="max-w-2xl w-full">
          <div className="bg-brand-teal text-white rounded-2xl rounded-tr-sm px-4 py-3 space-y-2">
            {att ? (
              <>
...
function AttachmentCard({ filename }) {
  return (
    <div className="bg-brand-teal/40 rounded-xl px-3 py-2 text-xs flex items-center gap-1.5">
  ...
  return (
    <div className="flex items-center gap-0.5 mt-1.5 pl-1 opacity-100 sm:opacity-40 sm:group-hover:opacity-100 transition-opacity">
      ...
      <div className="flex items-center gap-1">
        ...
        {(sharing || shared) && (
          <span className={`text-xs font-medium transition-opacity ${shared ? 'text-blue-600' : 'text-gray-400'}`}>
